...
<template>
    <div class="p-5 bg-slate-100 rounded-x1 flex flex-col justify-between gap-2">
        <div>
            <img
                :src="imgUrl"
                alt=""
                class="mb4"
            />
            <h3 class="text-x1 font-semibold">
                {{title}}
            </h3>
        </div>
        <div class="flex items-center justify-between gap-2">
            <div>
                <p class="text-slate-500">Цена</p>
                <b class="text-x1">{{price}} ₽</b>
            </div>
            <div class="flex items-center gap-3">
                <button
                    class="rounded-4xl bg-white shadow p-3 cursor-pointer hover:scale-110 transition">
